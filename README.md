...
## Instructions
1. Navigate to [AutoLiF](https://github.com/rydland/autolif) and [download my scripts](https://github.com/rydland/autolif/archive/master.zip).
...
* __AutoFarm 1*∞__
  * _[Shift + F1]_
    * Automatically sows seeds or harvests crops on current and the next tiles in a straight walking pattern. Requires "Sow" as your left-click option on soil tiles & "Harvest" as your left-click option on crop tiles.
## WIP a/o 26/03/2019
* AutoGather
