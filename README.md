...
* 10 mouse sensitivity in-game.
  * You may want to modify your mouse DPI if the sensitivities mentioned above is too fast/slow. Mouse DPI is usually based on hardware and not within Windows, so changing it will not affect the performance of AutoLiF.
